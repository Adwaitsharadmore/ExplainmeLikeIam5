...
export default function StoryExerciseMissionPage() {
  ...
  const generateMissionStory = async (profile: any) => {
    ...
    try {
      ...
      // Generate audio for first page but don't auto-play
            ...
            <CardContent className="p-6">
              ...
              <div className="bg-orange-50 rounded-lg p-4 mb-6">
                <p className="text-orange-800 text-center">
                  You did all the exercises in the story! You're amazing! Your
                  body got stronger and you had fun at the same time.
                </p>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                ...
                <p className="text-sm text-yellow-700">
                  Moving your body in different ways helps different muscles
                  grow strong. When you pretend to be animals or characters,
                  you're exercising in fun ways that help your body and
                  imagination!
                </p>
              </div>
            ...
            <CardContent className="p-6">
              <div className="mb-6">
                <div className="bg-orange-100 rounded-lg p-6">
                  <div className="story-content mb-4">
                    ...
                    {exercises[currentPage] && (
                      <motion.div
                        ...
                        transition={{ duration: 0.5 }}
                      >
                        <span className="font-bold">Let's move!</span>{" "}
                        {exercises[currentPage]}
                      </motion.div>
                    )}
                  </div>
                  ...
                  <div className="flex justify-center mb-4">
                    ...
                    {audioUrls[currentPage] && (
                      <audio ref={audioRef} src={audioUrls[currentPage]} />
                    )}
                  </div>
              ...
              <div className="bg-orange-50 rounded-lg p-3 text-sm text-orange-700">
                <p className="text-center">
                  Follow along with the story and do the exercises when they
                  appear. Have fun moving your body!
                </p>
              </div>
            </CardContent>
          </Card>
